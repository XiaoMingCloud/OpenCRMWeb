...
import XiaomingcloudDepCheckbox from '../../XiaomingcloudUserSelect/src/XiaomingcloudDepCheckbox'
import XiaomingcloudUserCheckbox from '../../XiaomingcloudUserSelect/src/XiaomingcloudUserCheckbox'
...
import { getSearchRequestWithRequest } from '../../XiaomingcloudUserSelect/src/utils'

const DefaultXiaomingcloudUser = {
  value: 'userId',
  label: 'realname'
}


const DefaultXiaomingcloudDep = {
  value: 'deptId',
  label: 'name'
}
...
export default {
  name: 'XiaomingcloudUserDep', // 新建 XiaomingcloudUserDep
  components: {
    XiaomingcloudDepCheckbox,
    XiaomingcloudUserCheckbox
  },
  inheritAttrs: false,
  props: {
    headerShow: {
  ...
  computed: {
    userConfig() {
      return merge({ ...DefaultXiaomingcloudUser }, this.userProps || {})
    },

    depConfig() {
      return merge({ ...DefaultXiaomingcloudDep }, this.depProps || {})
    },
...
/deep/ .Xiaomingcloud-dep-checkbox {
  &.is-select-user {
    .el-checkbox__input {
      display: none;
    }
