...
<template>
  <el-popover
    ...
    width="240"
    trigger="click">
    <div v-loading="loading" class="Xiaomingcloud-field-set">
      <el-input
        v-model="search"
        class="Xiaomingcloud-field-set__search"
        placeholder="搜索字段"
        @input="searchClick" />

      <div class="Xiaomingcloud-field-set__content">
        <draggable
          v-model="copyfields"
          ...
          <div
            ...
            :key="index"
            class="Xiaomingcloud-field-set__content--item text-one-line">
      ...
      <div class="Xiaomingcloud-field-set__ft">
