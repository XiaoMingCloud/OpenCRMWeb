<template>
  <div ref="XiaomingcloudSignaturePad" class="Xiaomingcloud-signature-pad">
    ...
    <template v-else>
      <vue-signature-pad
        ...
        width="100%"
      />
      <div class="Xiaomingcloud-signature-pad__handle">
        <el-button type="text" icon="xiaomingcloud open-icon-reply" @click="handleClick('undo')">撤回</el-button>
        <el-button type="text" icon="xiaomingcloud open-icon-bin" @click="handleClick('clear')">清空</el-button>
      </div>
    </template>
  </div>
</template>
...
import XiaomingcloudSignatureImage from './Image'
...
export default {
  // 签名
  name: 'XiaomingcloudSignaturePad',
  ...
  mounted() {
    ...
    this.height = `${parseInt(this.$refs.XiaomingcloudSignaturePad.clientWidth / 2.6)}px`
  },
