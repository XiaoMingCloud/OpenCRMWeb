<template>
  <div class="Xiaomingcloud-detail-table">
...
<script>
import XiaomingcloudTableItems from './XiaomingcloudTableItems.vue'
...
export default {
  // 明细表格
  name: 'XiaomingcloudDetailTable',

  components: {
    XiaomingcloudFormItems: () => import('../XiaomingcloudForm/XiaomingcloudFormItems.vue'),
    XiaomingcloudTableItems: XiaomingcloudTableItems
  },
