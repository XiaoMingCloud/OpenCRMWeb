<template>
  <div v-if="fieldForm && fieldForm.length > 0" class="Xiaomingcloud-detail-table-view">
        ...
        <flexbox
          ...
          <template v-for="(item, index) in children">
            <div
              ...
              class="Xiaomingcloud-form-item">
              <div class="Xiaomingcloud-form-item__label">{{ item.name }}</div>
    ...
    <div
      ...
      <el-table
        ...
        class="Xiaomingcloud-table-items"
        style="width: 100%">
        <el-table-column
...
<script>
export default {
  // XiaomingcloudDetailTableView 明细表格详情
  name: 'XiaomingcloudDetailTableView',

  components: {
    XiaomingcloudFieldView: () => import('@/components/NewCom/XiaomingcloudForm/XiaomingcloudFieldView')
  },
...
.Xiaomingcloud-detail-table-view {
  ...
  .Xiaomingcloud-form-item {
    ...
    &.is-desc_text {
      .Xiaomingcloud-form-item__label {
        display: none;
      }
    }
  }
