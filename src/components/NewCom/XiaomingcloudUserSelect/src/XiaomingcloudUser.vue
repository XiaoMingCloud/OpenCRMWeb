...
import XiaomingcloudDepCheckbox from './XiaomingcloudDepCheckbox'
import XiaomingcloudUserCheckbox from './XiaomingcloudUserCheckbox'
...
export default {
  name: 'XiaomingcloudUser', // 新建 user
  components: {
  ...
  computed: {
    config() {
      return merge({ ...DefaultXiaomingcloudUser }, this.props || {})
    },
