<template>
  <div
    ...
    wrap="wrap"
    class="Xiaomingcloud-user-select xh-form-border"
      ...
      <Xiaomingcloud-select-dropdown
        ...
        <el-scrollbar
          ...
          <Xiaomingcloud-user
            ...
            :props="config"
            :radio="radio"
            @change="XiaomingcloudUserChange"
            @close="visible = false" />
        </el-scrollbar>
      </Xiaomingcloud-select-dropdown>
    </transition>
...
import XiaomingcloudUser from './src/XiaomingcloudUser.vue'
...
const DefaultXiaomingcloudUserSelect = {
  value: 'userId',
  label: 'realname',
...
export default {
  ...
  computed: {
    ...
    // 合并 props
    config() {
      const props = merge({ ...DefaultXiaomingcloudUserSelect }, this.props || {})
      if (this.request) {
...
.Xiaomingcloud-user-select.is_disabled {
...
.Xiaomingcloud-user-select.is_valid:hover {
  border-color: #c0c4cc;
}

.Xiaomingcloud-user-select.is_focus {
