...
<template>
  <flexbox class="Xiaomingcloud-user-select" align="stretch">
    <div v-loading="loading" class="Xiaomingcloud-user-select__left">
      <div class="Xiaomingcloud-user-select__header">
        <el-autocomplete
          v-model="searchInput"
      ...
      <div class="Xiaomingcloud-user-select__body">
        <el-breadcrumb
          style="padding: 5px 0;"
        ...
        <div class="Xiaomingcloud-user-select__list">
          <flexbox
            v-for="(item, index) in showDataList"
            :key="index"
            class="Xiaomingcloud-user-select__item">
            <el-checkbox
            ...
            <template v-if="item.isDep">
              ...
              <el-button
                ...
                type="text"
                icon="xiaomingcloud open-icon-structure"
    ...
    <div class="Xiaomingcloud-user-select__right">
