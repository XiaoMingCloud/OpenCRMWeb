  ...
  <div
    ...
    <el-input
      ...
      <template slot="suffix">
        ...
        <i v-else class="xiaomingcloud open-icon-location" />
      </template>
    </el-input>

    <Xiaomingcloud-location-point-dialog
      :value="dataValue"
...
<script>
import XiaomingcloudLocationPointDialog from '../XiaomingcloudLocationPointDialog'
...
export default {
  // 定位
  name: 'XiaomingcloudLocation',

  components: {
    XiaomingcloudLocationPointDialog
  },
