<template>
  <div
    ...
    wrap="wrap"
    class="Xiaomingcloud-dep-select xh-form-border"
...
<script>
import XiaomingcloudSelectDropdown from './src/SelectDropdown.vue'
import XiaomingcloudDep from './src/XiaomingcloudDep.vue'
...
const DefaultXiaomingcloudDepSelect = {
  value: 'deptId',
  label: 'name',
...
export default {
  name: 'XiaomingcloudDepSelect',

  components: {
    XiaomingcloudSelectDropdown,
    XiaomingcloudDep: XiaomingcloudDep
  },
  ...
  computed: {
    ...
    // 合并 props
    config() {
      const props = merge({ ...DefaultXiaomingcloudDepSelect }, this.props || {})
      if (this.request) {
...
.Xiaomingcloud-dep-select.is_disabled {
...
.Xiaomingcloud-dep-select.is_valid:hover {
  border-color: #c0c4cc;
}

.Xiaomingcloud-dep-select.is_focus {
