<template>
  <div class="Xiaomingcloud-empty">
    <div class="Xiaomingcloud-empty__title">{{ config.emptyText || '暂无数据' }}</div>
    <el-button
      v-if="config.showButton"
      :icon="config.buttonIcon"
      class="Xiaomingcloud-empty__button xr-btn--orange"
      type="primary"
