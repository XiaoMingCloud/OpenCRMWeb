<template>
  ...
  <el-timeline v-else>
    <el-timeline-item
      ...
      :key="index"
      class="Xiaomingcloud-approval-item">
      <div class="Xiaomingcloud-approval-item__header">{{ flow.name }}<span>{{ getExamineTypeName(flow.examineType) }}</span></div>
      <div class="Xiaomingcloud-approval-item__body">
...
export default {
  // 审批流的应用参数
  name: 'XiaomingcloudApprovalFlowApply',
