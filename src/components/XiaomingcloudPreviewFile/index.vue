    ...
    <div class="fixedHandle">
      ...
      <flexbox
        ...
        <div class="handle-box">
          <i
            class="xiaomingcloud open-zoom-in"
            @click="enlarge" />
          <i
            class="xiaomingcloud open-zoom-on"
            @click="reduce" />
          <i
            class="xiaomingcloud open-rotate"
            @click="rotate" />
          <i
            class="xiaomingcloud open-download"
            @click="downloadFile" />
        </div>
...
import {
  ...
  canPreviewFile,
  XiaomingcloudPreviewFile
  // getImageData
} from '@/utils'
import { downloadFileAPI } from '@/api/common'

export default {
  name: 'XiaomingcloudPreviewFile',
  props: {},
  data() {
    return {
      visible: false,
  ...
  methods: {
    ...
    previewFile() {
      if (this.currentFile.url) {
        XiaomingcloudPreviewFile(this.currentFile.url, this.currentFile.name)
      }
    },
