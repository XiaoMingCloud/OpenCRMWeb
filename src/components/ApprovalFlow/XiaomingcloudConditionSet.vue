  ...
  <el-drawer
    ...
    <flexbox v-if="editNode" class="drawer-header">
      <div class="edit-title">
        ...
        <template v-else>
          ...
          <i class="xiaomingcloud open-edit" @click="titleEditClick" />
        </template>
      </div>
      <el-popover
        placement="bottom"
    ...
    <div v-if="editNode" class="drawer-body">
      <el-row
        ...
        <el-col :span="1" class="set-row__footer"><i class="xiaomingcloud open-delete" @click="deleteItem(index)" /></el-col>
      </el-row>
      <div>
    ...
    <Xiaomingcloud-condition-select
      :props="props"
...
<script>
import XiaomingcloudConditionSelect from './XiaomingcloudConditionSelect.vue'
...
export default {
  // 条件配置
  name: 'XiaomingcloudConditionSet',

  components: {
    XiaomingcloudConditionSelect: XiaomingcloudConditionSelect,
    Draggable,
