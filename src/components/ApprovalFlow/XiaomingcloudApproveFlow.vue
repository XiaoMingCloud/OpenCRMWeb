<template>
  <div class="Xiaomingcloud-approve-flow-wrap">
    <el-button-group>
      <el-button
        :disabled="scale <= 0.5"
        icon="el-icon-minus"
    ...
    <div
      ...
      class="Xiaomingcloud-approve-flow">
      <Xiaomingcloud-node
        v-if="sendNode"
        :visible-arrow="false"
        :node="sendNode"
      ...
      <Xiaomingcloud-end-node />
      <Xiaomingcloud-condition-set
...
import XiaomingcloudConditionWrap from './XiaomingcloudConditionWrap.vue'
import AddNodeBtn from './AddNodeBtn'
import XiaomingcloudEndNode from './XiaomingcloudEndNode.vue'
import XiaomingcloudConditionSet from './XiaomingcloudConditionSet.vue'
import XiaomingcloudNodeSet from './XiaomingcloudNodeSet.vue'
...
export default {
  name: 'XiaomingcloudApproveFlow',

  components: {
    XiaomingcloudNode: XiaomingcloudNode,
    XiaomingcloudConditionWrap: XiaomingcloudConditionWrap,
    AddNodeBtn,
    XiaomingcloudEndNode: XiaomingcloudEndNode,
    XiaomingcloudConditionSet: XiaomingcloudConditionSet,
    XiaomingcloudNodeSet: XiaomingcloudNodeSet
  },
  ...
  methods: {
     ...
     */
    getNodeParams(data) {
      data.isError = this.getXiaomingcloudNodeErrorStatus(data)
