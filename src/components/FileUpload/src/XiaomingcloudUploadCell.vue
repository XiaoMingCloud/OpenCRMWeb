<template>
  <flexbox class="Xiaomingcloud-upload-cell">
    <img
      :src="fileIcon"
      class="Xiaomingcloud-upload-cell__header">
    <div class="Xiaomingcloud-upload-cell__body">
    ...
    <div class="Xiaomingcloud-upload-cell__footer">
      <el-button
