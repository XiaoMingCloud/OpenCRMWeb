<template>
  <flexbox
    :gutter="gutter"
    align="stretch"
    class="Xiaomingcloud-base-detail-section"
    wrap="wrap">
    <flexbox-item
      ...
      <flexbox
        align="stretch"
        class="Xiaomingcloud-base-detail-section__item">
    ...
    <el-dropdown
      ...
      trigger="hover"
      class="Xiaomingcloud-base-detail-section__more"
...
export default {
  name: 'XiaomingcloudBaseDetailSection',
  components: {
    FileListView,
