<template>
  <el-radio-group v-model="dateType" class="Xiaomingcloud-plan-date" @change="radioChange">
...
<script>
import XiaomingcloudMultiDate from './XiaomingcloudMultiDate'
...
export default {
  // 计划回款日期
  name: 'XiaomingcloudPlanDate',

  components: {
    XiaomingcloudMultiDate
  },
