      ...
      leftSides: [
        {
          ...
          crmType: 'leads',
          color: '#c623fb',
          iconClass: 'xiaomingcloud open-leads',
          infoType: 'todayLeads',
          model: 11,
          num: 0,
          tips: '下次跟进时间为今日的线索',
        ...
        },
        {
          ...
          crmType: 'customer',
          color: '#2362FB',
          iconClass: 'xiaomingcloud open-customer',
        ...
        },
        {
          ...
          crmType: 'business',
          color: '#fb9323',
          iconClass: 'xiaomingcloud open-business',
        ...
        },
        {
          ...
          crmType: 'customer',
          color: '#19B5F6',
          iconClass: 'xiaomingcloud open-s-seas',
        ...
        },
        {
          ...
          crmType: 'customer',
          color: '#26D4DA',
          iconClass: 'xiaomingcloud open-seas',
        ...
        },
        {
          ...
          crmType: 'contract',
          color: '#FD5B4A',
          iconClass: 'xiaomingcloud open-contract',
        ...
        },
        {
          ...
          crmType: 'receivables',
          color: '#FFB940',
          iconClass: 'xiaomingcloud open-receivables',
        ...
        },
        {
          ...
          color: '#27BA4A',
          iconClass: 'xiaomingcloud open-bell',
        ...
        },
        {
          ...
          crmType: 'contract',
          color: '#ff9232',
          iconClass: 'xiaomingcloud open-house',
        ...
        },
        {
          ...
          crmType: 'invoice',
          color: '#ff9232',
          iconClass: 'xiaomingcloud open-invoice',
