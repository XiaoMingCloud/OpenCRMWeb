    ...
    getDetail() {
      ...
      hrmEmployeeSocialSecurityQueryByIdAPI(this.id)
        .then(res => {
          ...
          const securityList = []
          const securityField = employeeSecurity.getFields()
    ...
    securityCommandSelect(command) {
      if (command == 'edit') {
        ...
        this.getSchemList().then(() => {
          this.formAddFields = employeeSecurity.getFields(this.schemeList)
          this.formAddDialogShow = true
        })
      }
    },
